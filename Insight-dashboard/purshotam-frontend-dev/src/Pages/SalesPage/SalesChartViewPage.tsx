...
const SalesChartViewPage: React.FC = () => {
  return (
    <div className="flex flex-col overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4 px-4 lg:px-8">
        ...
        <div className="flex flex-col w-full lg:w-1/2 gap-4 rounded-xl border p-4 border-[#D7D7D7]/55 shadow-[0px_1px_4px_rgba(12,12,13,0.1)]">
